...
document.addEventListener('DOMContentLoaded', () => {
  const $root = __WEBPACK_IMPORTED_MODULE_0_jquery__('#root');
...
function getWeather() {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_jquery__["ajax"]({
    method: 'GET',
    url: `https://api.aerisapi.com/forecasts/11101?client_id=${id}&client_secret=${key}`
  });
}
...
class Weather {
  ...
  setup() {
    this.$root = __WEBPACK_IMPORTED_MODULE_0_jquery__('#root');
  }
  
  handleSwitch() {
    this.defaultView = this.defaultView === 'F' ? 'C' : 'F';
    __WEBPACK_IMPORTED_MODULE_0_jquery__('.day-list').remove();
    this.renderWeather();
  }
  ...
  renderHeader() {
    ...
    const $h2 = __WEBPACK_IMPORTED_MODULE_0_jquery__('<h2>')
  ...
  getToggleButton() {
    ...
    const $button = __WEBPACK_IMPORTED_MODULE_0_jquery__('<button>').append(`Switch to ${switchTo}`)
      .addClass('button')
  ...
  renderWeather() {
    const $ul = __WEBPACK_IMPORTED_MODULE_0_jquery__('<ul>').addClass('day-list');
  ...
  createLi(day) {
    ...
    const $day = __WEBPACK_IMPORTED_MODULE_0_jquery__('<h5>')
      .append(this.dayStrings[date.getDay()])
      .addClass('day');
    const $stamp = __WEBPACK_IMPORTED_MODULE_0_jquery__('<h5>')
      .append(`${date.getMonth() + 1}-${date.getDate()}-${date.getFullYear()}`)
      .addClass('date-stamp');
    const $icon = __WEBPACK_IMPORTED_MODULE_0_jquery__('<section>')
      .append(`<img src="icons/${day.icon}">`)
      .addClass('icon');
    const $min = __WEBPACK_IMPORTED_MODULE_0_jquery__('<span>')
      .append('Low: ' + day[`minTemp${this.defaultView}`] + this.defaultView)
      .addClass('temp');
    const $max = __WEBPACK_IMPORTED_MODULE_0_jquery__('<span>')
      .append('High: ' + day[`maxTemp${this.defaultView}`] + this.defaultView)
      .addClass('temp');
    const $li = __WEBPACK_IMPORTED_MODULE_0_jquery__('<li>').addClass('day-item');
